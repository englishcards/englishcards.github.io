...
},
{
  ...
  ru: ['Рука', 'Спина', 'Ухо', 'Палец', 'Головная боль', 'Боль в животе', 'Нога', 'Боль в горле', 'Насморк', 'Зубная боль', 'Кашель', 'Простуда', 'Ответ', 'Выключить телефон', 'Поговорить', 'Забыть имя', 'Обменяться номерами', 'Запомнить номер', 'Медленно', 'Осторожно, внимательно', 'Ужасно']
},
{
  name: "Unit-12",
  eng: ['Watch the sun rise', 'Climb a mountain', 'Be in a film', 'Ride an elephant', 'Sleep outside', 'Meet someone famous', 'Call me back', 'Hold on', 'Hang up'],
  ru: ['Смотреть, как встаёт солнце', 'Взбираться на гору', 'Сниматься в фильме', 'Кататься на слоне', 'Спать на улице', 'Встретить кого-то знаменитого', 'Перезвоните мне', 'Не вешайте трубку', 'Положить трубку']
},

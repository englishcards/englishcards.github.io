...
let answerInput = document.querySelector('.answer-textarea');
...
btnNext.onclick = () => {
	...
	if(counter == 9) {
		const formPractice = document.querySelector('.practice-form_2');
		const formPracticeBtn = document.querySelector('.question-btn_practice_2');
...
function checkAnswer() {
	let answerInput = document.querySelector('.answer-textarea').value;
...
function chooseTrue() {
	...
	result.innerText = `${resultCounter} %`;
	document.querySelector('.answer-textarea').classList.add('textarea-correct');
	signAnswer.classList.add('sign-correct');
}

function chooseFalse() {
	showAnswerAll();
	document.querySelector('.answer-textarea').classList.add('textarea-incorrect');
...
function showAnswerAll() {
	...
	showAnswer.classList.add('answer-correct-practice');
	document.querySelector('.answer-textarea').disabled = true;
}

function removeAnswer() {
	showAnswer.hidden = true;
	signAnswer.hidden = true;
	document.querySelector('.answer-textarea').disabled = false;
	showAnswer.classList.remove('answer-correct-practice');
	showAnswer.classList.remove('answer-incorrect');
	document.querySelector('.answer-textarea').classList.remove('textarea-correct');
	document.querySelector('.answer-textarea').classList.remove('textarea-incorrect');

...
let form;
if (mainUrl.includes('test.php')) sendResult('.test1-form', 'test.php', progressTable[0], 'input[name="test-result1"]', 'test-result1=');
if (mainUrl.includes('test_2.php')) sendResult('.test2-form', 'test_2.php', progressTable[1], 'input[name="test-result2"]', 'test-result2=');

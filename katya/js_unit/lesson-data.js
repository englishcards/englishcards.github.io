...
},
{
	...
	words: `Another file`,			
	text: `<h2 class="main-title text-title">My week</h2>
				<p class="text-paragraph">Hello, everyone! Jack is speaking.<img src="units/3/text/0.jpg" style="float: right; width:180px; padding-left: 10px;"></p>
				<p class="text-paragraph">Today I'm going to tell you about my last week.</p>
				<p class="text-paragraph">On Monday I was in New York. I ate a big hamburger, drank coca-cola and watched The Statue of Liberty. I was there three days. I love New York.</p>
				<p class="text-paragraph"><img src="units/3/text/1.jpg" style="float: left; width:210px; padding-right: 10px;">On Thursday I came to Miami. I thought it was the hottest time in my life. The temperature was 40 degrees above zero. But you know what, I liked Miami too. I took a book, sat near the ocean and read. My dream came true.</p>
				<p class="text-paragraph">On Friday I back home. By the way, I met Celine Dion at the airport of Miami. Yeah, that journey was unforgettable</p>
				<p class="text-paragraph">What about your weekend? Write your comment and subscribe to my channel. Bye!</p>`,
	practice: ``,
	listening: `<div class="listening-wrap">
					<div class="track-list">
						<h2 class="main-title track-list_header">Track-1</h2>
					...
					<div class="dialogue">
						<img src="units/3/audio/0.jpg" width="400px;">
					</div>
					<div class="audio-player-wrap">
						<audio class="audio-player"></audio>
						<progress class="listening__progress" value="0" max="100"></progress>
	...
	homework: `<div class="homework-wrap">
					<h2 class="main-title">Homework</h2>
					<ul class="homework-list">
						<li class="gramar-item">Learn new words from Unit 3</li>
						<li class="gramar-item">Work Book: Exercise 1 and 2A, 2B page 37</li>
						<li class="gramar-item">Work Book: Exercise 1B page 38</li>
						<li class="gramar-item">Learn irregular verbs</li>
					</ul>	
				</div>`,
},

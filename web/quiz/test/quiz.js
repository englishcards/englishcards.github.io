...
if (mainUrl.includes('test1')) questionList.innerHTML = quizAnswers[0].questions;
if (mainUrl.includes('test2')) questionList.innerHTML = quizAnswers[1].questions;
...
btnEndTest.addEventListener('click', () => {
	window.scrollTo(0,0);
	calculateTotal();
